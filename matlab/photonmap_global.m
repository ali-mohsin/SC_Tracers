function output_color = photonmap_global( origin,  direction, triangle_list,light_power,depth )
        ...
        elseif (triangle(16) == 68) % it is a diffusive surface
           ...
           if( rand()>=p)   %absorption
               ...
               dir = u*cos(r1)*r2s+v*sin(r1)*r2s+nhit*sqrt(1-r2);
                ...
                output_color = photonmap_global(inter_position+dir*1e-2,dir,triangle_list,light_power.*triangle(10:12)/p,depth+1);
           end
           end
...
%                         output_color = photonmap(inter_position,refract_dir,triangle_list,light_power*transmission,depth+1);
%                     else
%                         output_color = photonmap(inter_position,reflect_dir,triangle_list,light_power*reflection,depth+1);
%                     end
%                     
...
%                          output_color = photonmap(inter_position,reflect_dir,triangle_list,light_power,depth+1);
%                     else
